...
public class App {
    ...
    public static void main(String[] args) {
        ...
        //curentFullPath = currentUsersHomeDir+ File.separator +"fake"+ File.separator +"botstarter";
        String callbackUrl = "";
        if (args.length > 1) {
            callbackUrl = args[1];
        }
        ...
        try {        
            ...
            File mainConfigFile = new File(curentFullPath + File.separator + "config" + File.separator + "settings.json");
