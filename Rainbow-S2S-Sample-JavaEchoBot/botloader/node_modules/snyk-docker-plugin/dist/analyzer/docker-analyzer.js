...
function analyze(targetImage, dockerfileAnalysis, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            yield imageInspector.pullIfNotLocal(targetImage, options);
        }
        catch (error) {
        ...
        try {
            pkgManagerAnalysis = yield Promise.all([
        ...
        let binarisAnalysis;
        try {
            binarisAnalysis = yield binariesAnalyzer.analyze(targetImage, installedPackages, pkgManager, options);
        }
        catch (error) {
