...
class InlineObject2 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'timestamp' => 'string',
        'chatstate' => '\Ale\Rainbow\S2S\Client\S2S\Model\ApiRainbowUcsV10ConnectionsChatstate'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['chatstate'] === null) {
            $invalidProperties[] = "'chatstate' can't be null";
        }
     ...
     * Gets chatstate
     *
     * @return \Ale\Rainbow\S2S\Client\S2S\Model\ApiRainbowUcsV10ConnectionsChatstate
     */
     ...
     * Sets chatstate
     *
     * @param \Ale\Rainbow\S2S\Client\S2S\Model\ApiRainbowUcsV10ConnectionsChatstate $chatstate chatstate
     *
     * @return $this
     */
