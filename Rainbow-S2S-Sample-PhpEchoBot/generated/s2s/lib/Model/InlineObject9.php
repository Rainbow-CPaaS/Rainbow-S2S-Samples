...
class InlineObject9 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'timestamp' => 'string',
        'room_state' => '\Ale\Rainbow\S2S\Client\S2S\Model\ApiRainbowUcsV10ConnectionsRoomState'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['room_state'] = isset($data['room_state']) ? $data['room_state'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['room_state'] === null) {
            $invalidProperties[] = "'room_state' can't be null";
        }
     ...
     * Gets room_state
     *
     * @return \Ale\Rainbow\S2S\Client\S2S\Model\ApiRainbowUcsV10ConnectionsRoomState
     */
    public function getRoomState()
    {
        return $this->container['room_state'];
    }

    /**
     * Sets room_state
     *
     * @param \Ale\Rainbow\S2S\Client\S2S\Model\ApiRainbowUcsV10ConnectionsRoomState $room_state room_state
     *
     * @return $this
     */
    public function setRoomState($room_state)
    {
        $this->container['room_state'] = $room_state;
