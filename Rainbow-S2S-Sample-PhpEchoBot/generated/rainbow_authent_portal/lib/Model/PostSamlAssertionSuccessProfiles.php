...
/**
 * PostSamlAssertionSuccessProfiles Class Doc Comment
 *
 * @category Class
 * @package  Ale\Rainbow\S2S\Client\AuthPortal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PostSamlAssertionSuccessProfiles implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostSamlAssertionSuccess_profiles';
    ...
    protected static $openAPITypes = [
        ...
        'profile_id' => 'string',
        'profile_name' => 'string',
        'provisioning_needed' => '\Ale\Rainbow\S2S\Client\AuthPortal\Model\PostSamlAssertionSuccessProvisioningNeeded[]',
        'status' => 'string',
    ...
    public function setOfferTechnicalDescription($offer_technical_description)
    {
        if (!is_null($offer_technical_description) && (mb_strlen($offer_technical_description) > 512)) {
            throw new \InvalidArgumentException('invalid length for $offer_technical_description when calling PostSamlAssertionSuccessProfiles., must be smaller than or equal to 512.');
        }
        if (!is_null($offer_technical_description) && (mb_strlen($offer_technical_description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_technical_description when calling PostSamlAssertionSuccessProfiles., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Ale\Rainbow\S2S\Client\AuthPortal\Model\PostSamlAssertionSuccessProvisioningNeeded[]|null
     */
     ...
     *
     * @param \Ale\Rainbow\S2S\Client\AuthPortal\Model\PostSamlAssertionSuccessProvisioningNeeded[]|null $provisioning_needed Array of Objects which indicates if account must be provisioned on other internal components when subscribing to this offer.
     *
     * @return $this
     */
