...
/**
 * GetRenewSuccessLoggedInUser Class Doc Comment
 *
 * @category Class
 * @package  Ale\Rainbow\S2S\Client\AuthPortal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetRenewSuccessLoggedInUser implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetRenewSuccess_loggedInUser';
    ...
    protected static $openAPITypes = [
        ...
        'display_name' => 'string',
        'emails' => '\Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessEmails[]',
        ...
        'phone_numbers' => '\Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessPhoneNumbers[]',
        'profiles' => '\Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessProfiles[]',
        'roles' => 'string[]',
        'site_id' => 'string',
        'tags' => 'string[]',
        'time_to_live' => 'float',
     ...
     * Gets emails
     *
     * @return \Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessEmails[]
     */
     ...
     * Sets emails
     *
     * @param \Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessEmails[] $emails Array of user emails addresses objects
     *
     * @return $this
     */
     ...
     * Gets phone_numbers
     *
     * @return \Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessPhoneNumbers[]
     */
     ...
     * Sets phone_numbers
     *
     * @param \Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessPhoneNumbers[] $phone_numbers Array of user phone numbers objects. <br/> Phone number objects can: <ul>     <li> be created by user (information filled by user),</li>     <li> come from association with a system (pbx) device (association is done by admin).</li> </ul>
     *
     * @return $this
     */
     ...
     * Gets profiles
     *
     * @return \Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessProfiles[]
     */
     ...
     * Sets profiles
     *
     * @param \Ale\Rainbow\S2S\Client\AuthPortal\Model\GetRenewSuccessProfiles[] $profiles User profile Objects.
     *
     * @return $this
     */
