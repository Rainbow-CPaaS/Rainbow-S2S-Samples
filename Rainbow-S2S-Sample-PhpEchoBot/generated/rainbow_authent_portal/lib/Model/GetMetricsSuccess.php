...
/**
 * GetMetricsSuccess Class Doc Comment
 *
 * @category Class
 * @package  Ale\Rainbow\S2S\Client\AuthPortal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetMetricsSuccess implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetMetricsSuccess';
     ...
     * Sets metrics
     *
     * @param string $metrics In JSON format, all the metrics available
     *
     * @return $this
     */
