...
myS2sStarterkit.events.on('rainbow_onbubblestatechanged', (data) => {
    console.log('S2sStarterkit : rainbow_onbubblestatechanged : ' + JSON.stringify(data));
});

myS2sStarterkit.events.on('rainbow_onbubblememberchanged', (data) => {
    console.log('S2sStarterkit : rainbow_onbubblememberchanged : ' + JSON.stringify(data));
});
