...
function getDependencies(targetImage, dockerfileAnalysis, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = parseAnalysisResults(targetImage, output, dockerfileAnalysis);
            const pkg = buildTree(targetImage, result.type, result.depInfosList, result.targetOS);
            return {
                package: pkg,
