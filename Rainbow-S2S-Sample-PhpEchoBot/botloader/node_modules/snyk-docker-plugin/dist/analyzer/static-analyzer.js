...
const static_4 = require("../inputs/os-release/static");
const static_5 = require("../inputs/rpm/static");
...
function analyze(targetImage, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const staticAnalysisActions = [
            ...
            static_5.getRpmDbFileContentAction,
            ...static_4.getOsReleaseActions,
        ...
        const [apkDbFileContent, aptDbFileContent, rpmDbFileContent,] = yield Promise.all([
            ...
            static_5.getRpmDbFileContent(archiveLayers, options.tmpDirPath),
        ]);
